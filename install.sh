...
function DOMAINS_MANAGER() {
    ...
    if [ "$DOMAINS_SELECT" == "1" ]; then
        ...
        wget https://raw.githubusercontent.com/ianexec/newltxv7/v7project/domains.sh \
...
INSTALL_WEBSOCKET() {
wget https://raw.githubusercontent.com/ianexec/newltxv7/v7project/ws/install-ws.sh && chmod +x install-ws.sh && ./install-ws.sh
wget https://raw.githubusercontent.com/ianexec/newltxv7/v7project/ws/banner_ssh.sh && chmod +x banner_ssh.sh && ./banner_ssh.sh
}
...
INSTALL_OHP() {
wget https://raw.githubusercontent.com/ianexec/newltxv7/v7project/ws/ohp.sh && chmod +x ohp.sh && ./ohp.sh
}

INSTALL_FEATURE() {
wget https://raw.githubusercontent.com/ianexec/newltxv7/v7project/menu/install_menu.sh && chmod +x install_menu.sh && ./install_menu.sh
}

INSTALL_UDP_CUSTOM() {
wget https://raw.githubusercontent.com/ianexec/newltxv7/v7project/ws/UDP.sh && chmod +x UDP.sh && ./UDP.sh
}
...
wget https://raw.githubusercontent.com/ianexec/newltxv7/v7project/install_cron.sh && chmod +x install_cron.sh && ./install_cron.sh
clear
}
...
echo -e "\e[91;1m ================================ \e[0m"
cd
wget https://raw.githubusercontent.com/ianexec/newltxv7/v7project/PACKAGES/tools.sh && chmod +x tools.sh && ./tools.sh
wget -q -O /etc/port.txt "https://raw.githubusercontent.com/ianexec/newltxv7/v7project/PACKAGES/port.txt"
...
wget https://raw.githubusercontent.com/ianexec/newltxv7/v7project/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
...
wget https://raw.githubusercontent.com/ianexec/newltxv7/v7project/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
clear
# limit quota & service xray
wget https://raw.githubusercontent.com/ianexec/newltxv7/v7project/Xbw_LIMIT/install.sh && chmod +x install.sh && ./install.sh
clear
# limit service ip xray
wget https://raw.githubusercontent.com/ianexec/newltxv7/v7project/killing_service/service.sh && chmod +x service.sh && ./service.sh
clear
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/ianexec/newltxv7/v7project/versi  )
